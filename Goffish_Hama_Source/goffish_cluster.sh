...
if [ $# -eq 0 ]; then
   ...
   echo "USAGE:"
   echo ""; echo ""; echo "";
   echo "goffish_cluster  start                     --To Start a new Goffish HAMA Cluster (Default: 4 Workers)"; echo "";
   echo "goffish_cluster  stop                     --To Stop the Goffish HAMA Cluster"; echo "";
   echo "goffish_cluster  scale  <No. of Workers>   --To Scale IN or OUT the Workers"; echo "";
   echo "goffish_cluster  visualise                 --To Start a Dashboard for Swarm Cluster"; echo "" ;
   echo "goffish_cluster  login                     --To login to the Master Node"; echo "" ;
elif [ $1 == "start" ]; then
